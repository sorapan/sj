...
(function() {
  var CheckTopicStatus, DelImgInDir, DragSetting, count, result_url, uploadImg, url, urlsplt;
  ...
  CheckTopicStatus = function() {
    return $.ajax({
      ...
      success: function(d) {
        if (d === '1') {
          return $('#update_header').html('อัพเดทครั้งที่ 2');
        } else if (d === '2') {
          return $('#update_header').html('อัพเดทครั้งที่ 3');
        }
      }
    });
  };
