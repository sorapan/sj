...
(function() {
  var AddCarUploadDiv, AddCarUploadDiv2, AddCarUploadDiv3, DelCarUpload, DelImgInDir, DragSetting, count, count2, count3, fetchImg, formControl, tpid, uploadDoc, url, urlsplt;
  ...
  formControl = function(num) {
    ...
    $('#add' + num).click(function() {
      ...
      $('#add_upload_div' + num).append('<div class="wrapall' + num + '" id="w' + c + '"> <div class="wait_car_img' + num + '">+</div> <input type="file" class="car_file' + num + '" name="file"> </div><br>');
      if (num === "") {
        return count++;
      } else if (num === "2") {
        return count2++;
